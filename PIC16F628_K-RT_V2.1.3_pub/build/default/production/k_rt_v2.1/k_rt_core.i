...
# 2 "<built-in>" 2
# 1 "k_rt_v2.1/k_rt_core.c" 2
# 93 "k_rt_v2.1/k_rt_core.c"
...
# 94 "k_rt_v2.1/k_rt_core.c" 2
# 1 "k_rt_v2.1/k_rt_core.h" 1
# 105 "k_rt_v2.1/k_rt_core.h"
__attribute__((inline)) void k_rt_task_20ms(void);
__attribute__((inline)) void k_rt_task_100ms(void);
__attribute__((inline)) void k_rt_task_1s(void);

void k_st_task_4ms(void);
void k_st_task_20ms(void);
void k_st_task_100ms(void);
void k_st_task_1s(void);

__attribute__((inline)) void k_schedule_task(char);
void k_stack_full(char);

__attribute__((inline)) void k_schedule_task_user(char);
void k_stack_full_user(char);
...
__attribute__((inline)) void k_systat_update_status();
# 95 "k_rt_v2.1/k_rt_core.c" 2
# 1 "k_rt_v2.1/k_rt_user.h" 1
# 136 "k_rt_v2.1/k_rt_user.h"
...
# 96 "k_rt_v2.1/k_rt_core.c" 2
# 192 "k_rt_v2.1/k_rt_core.c"
 char k_fault_word = 0;
 char k_alarm_word = 0;
 char k_status_word = ((1<<4) | (1<<0));
 ...
 __attribute__((inline)) char k_command(char ci) {
...
char act_stack_user_max = 0;
 ...
 __attribute__((inline)) void k_rt_task_4ms_isr_entry() {
    ...
    k_schedule_task(1);
    k_schedule_task_user(1);


    k_systat_load_rt_task_out();
    k_systat_load_rt_task_calc();
    k_systat_update_status();
# 375 "k_rt_v2.1/k_rt_core.c"
}


__attribute__((inline)) void k_rt_task_20ms() {

    k_schedule_task(2);
    k_schedule_task_user(2);
# 390 "k_rt_v2.1/k_rt_core.c"
}


__attribute__((inline)) void k_rt_task_100ms() {

    k_schedule_task(3);
    k_schedule_task_user(3);
}


__attribute__((inline)) void k_rt_task_1s() {

    k_schedule_task(4);
    k_schedule_task_user(4);
}
...
__attribute__((inline)) void k_schedule_task(char task) {
    if (scheduler_stack[k_sched_ptr_end]==0) {

      {
        act_stack++;
        scheduler_stack[k_sched_ptr_end]=task;
        if (k_sched_ptr_end<(16 - 1))
        k_sched_ptr_end++;
        else
        k_sched_ptr_end=0;
      }
      ...
      {
        if (scheduler_stack[k_sched_ptr_end])
          k_alarm_word |= (1<<0);
      }
    }
...
void k_task_handler(void) {
    ...
    {
      if (!(k_status_word & (1<<0))) return;
      if (!act_stack) return;
      act_stack--;
      if (scheduler_stack[k_sched_ptr_begin]==1) k_st_task_4ms();
      else if (scheduler_stack[k_sched_ptr_begin]==2) k_st_task_20ms();
      else if (scheduler_stack[k_sched_ptr_begin]==3) k_st_task_100ms();
      else if (scheduler_stack[k_sched_ptr_begin]==4) k_st_task_1s();

      scheduler_stack[k_sched_ptr_begin]=0;


      if (k_sched_ptr_begin<(16 - 1)) k_sched_ptr_begin++;
...
__attribute__((inline)) void k_schedule_task_user(char task) {
    if (scheduler_stack_user[u_sched_ptr_end]==0) {
      ...
      {
        if (scheduler_stack_user[u_sched_ptr_end])
          k_alarm_word |= (1<<4);
      }
    }
...
void k_task_handler_user(void) {
    ...
    {
      if (!(k_status_word & (1<<4))) return;
      if (!act_stack_user) return;
      act_stack_user--;

      if (scheduler_stack_user[u_sched_ptr_begin]==1) k_st_task_4ms_user();
      else if (scheduler_stack_user[u_sched_ptr_begin]==2) k_st_task_20ms_user();
      else if (scheduler_stack_user[u_sched_ptr_begin]==3) k_st_task_100ms_user();
      else if (scheduler_stack_user[u_sched_ptr_begin]==4) k_st_task_1s_user();

      scheduler_stack_user[u_sched_ptr_begin]=0;


      if (u_sched_ptr_begin<(16 - 1)) u_sched_ptr_begin++;
...
# 577 "k_rt_v2.1/k_rt_core.c"
uint8_t k_systat_load_rt_entry = 0x00;;
uint8_t k_systat_load_rt_exit = 0x00;;
uint8_t k_systat_load_rt_min = 0xff;;
uint8_t k_systat_load_rt_max = 0x00;;
uint8_t k_systat_load_rt_avg = 0x00;;
uint8_t k_systat_load_rt_tmr_reload_value = 0xFF;;
uint8_t k_systat_load_rt_tmr_roll = 0x00;;
...
__attribute__((inline)) void k_systat_init(void) {
  ...
  k_systat_load_rt_entry = 0x00;;
  k_systat_load_rt_exit = 0x00;;
  k_systat_load_rt_min = 0xff;;
  k_systat_load_rt_max = 0x00;;
  k_systat_load_rt_avg = 0x00;;
  k_systat_load_rt_tmr_roll = 0x00;;


  act_stack_min = 16;
  act_stack_max = 0;
  act_stack_user_min = 16;
...
# 684 "k_rt_v2.1/k_rt_core.c"
  k_systat_load_rt_avg = (k_systat_load_rt_avg >> 4) + (k_systat_load_rt_delta - (k_systat_load_rt_delta >> 4));

}
# 700 "k_rt_v2.1/k_rt_core.c"
__attribute__((inline)) void k_systat_update_status() {


  k_status_word &= ((1<<4)|(1<<0));
