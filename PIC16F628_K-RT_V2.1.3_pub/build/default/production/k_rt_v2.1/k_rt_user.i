...
# 2 "<built-in>" 2
# 1 "k_rt_v2.1/k_rt_user.c" 2
# 120 "k_rt_v2.1/k_rt_user.c"
...
__attribute__((inline)) char k_command_user(char ci) {
# 305 "k_rt_v2.1/k_rt_user.c"
...
# 358 "k_rt_v2.1/k_rt_user.c"
      if (byte_0 == 128) {
# 390 "k_rt_v2.1/k_rt_user.c"
        if (byte_1 < 8) {
          TRISA |= (1<<byte_1);
        } else if (byte_1 < 16) {
          TRISB |= (1<<(byte_1 - 8));
